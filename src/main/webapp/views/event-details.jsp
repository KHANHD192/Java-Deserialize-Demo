...
<!-- Mirrored from pixner.net/boleto/demo/event-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 12:43:40 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
        ...
        <div class="container">
            <div class="header-wrapper">
                ...
                <ul class="menu">
                    ...
                    <li>
                        <a href="#0" class="active">events</a>
                        <ul class="submenu">
                            <li>
                                <a href="events.html">Events</a>
                            </li>
                            <li>
                                <a href="#0" class="active">Event Details</a>
                            </li>
                            <li>
        ...
        <div class="row m-0">
            <div class="col-md-6 p-0">
                <div class="row m-0">
                    <div class="col-sm-6 p-0">
                        <div class="gallery-item two">
                            <div class="gallery-thumb">
                                <a href="assets/images/gallery/gallery01.jpg" class="img-pop">
                    ...
                    <div class="col-sm-6 p-0">
                        <div class="gallery-item two">
                            <div class="gallery-thumb">
                                <a href="assets/images/gallery/gallery02.jpg" class="img-pop">
                                    <i class="flaticon-loupe"></i>
                                </a>
                        ...
                        <div class="gallery-item two">
                            <div class="gallery-thumb">
                                <a href="assets/images/gallery/gallery03.jpg" class="img-pop">
                                    <i class="flaticon-loupe"></i>
                                </a>
            ...
            <div class="col-md-6 p-0">
                <div class="gallery-item">
                    <div class="gallery-thumb">
                        <a href="assets/images/gallery/gallery04.jpg" class="img-pop">
                            <i class="flaticon-loupe"></i>
                        </a>
    ...
    <!-- ==========Statistics-Section========== -->
    <section class="statistics-section padding-top padding-bottom bg_img pb-lg-0" data-background="assets/images/statistics/statistics-bg01.jpg">
        <div class="container">
            <div class="section-header-3">
...
<!-- Mirrored from pixner.net/boleto/demo/event-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 12:43:45 GMT -->
</html>