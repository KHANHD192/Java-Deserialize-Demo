...
<!-- Mirrored from pixner.net/boleto/demo/index by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 12:42:59 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="col-lg-9">
                    <div class="article-section padding-bottom">
                        <div class="section-header-1">
                            ...
                            <a class="view-all" href="movie-grid">View All</a>
                        </div>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="movie-grid">
                                    <div class="movie-thumb c-thumb">
                                        <a href="movie-details?id=<%=item.getMovieId()%>">
                                            <img src="<%= item.getPosterPath()%>" alt="movie">
                                        </a>
                                    </div>
                                    <div class="movie-content bg-one">
                                        <h5 class="title m-0">
                                            <a href="#0"><%=item.getTitle()%></a>
                                        </h5>
...
<!-- Mirrored from pixner.net/boleto/demo/index by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 12:43:16 GMT -->
</html>