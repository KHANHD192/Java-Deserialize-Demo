...
<!-- Mirrored from pixner.net/boleto/demo/apps-download.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 12:43:56 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <ul class="menu">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <li>
                                <a href="#0" class="active">Apps Download</a>
                            </li>
                            <li>
    ...
    <section class="apps-seciton padding-top pt-lg-0">
        <div class="container">
            <div class="apps-wrapper bg-six padding-top padding-bottom">
                <div class="bg_img apps-bg" data-background="assets/images/apps/apps01.png"></div>
