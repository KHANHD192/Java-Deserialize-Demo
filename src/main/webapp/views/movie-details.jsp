...
<!-- Mirrored from pixner.net/boleto/demo/movie-details by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 12:43:29 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <ul class="menu">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <li>
                                <a href="#0" class="active">Movie Details</a>
                            </li>
                            <li>
        ...
        <div class="container">
            <div class="details-banner-wrapper">
                <div class="details-banner-thumb">
                    <img src="${movie.getPosterPath()}" alt="movie">
                ...
                <div class="details-banner-content offset-lg-3">
                    ...
                    <div class="social-and-duration">
                        <div class="duration-area">
                            <div class="item">
                                <i class="fas fa-calendar-alt"></i><span>${movie.getTimeline()}</span>
                            </div>
                            <div class="item">
                                <i class="far fa-clock"></i><span>${movie.getDuration()} minus</span>
                            </div>
                        </div>
...
<!-- Mirrored from pixner.net/boleto/demo/movie-details by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 12:43:33 GMT -->
</html>