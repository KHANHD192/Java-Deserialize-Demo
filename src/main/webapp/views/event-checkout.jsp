...
<!-- Mirrored from pixner.net/boleto/demo/event-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 12:43:47 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <ul class="menu">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <li>
                                <a href="#0" class="active">Event Checkout</a>
                            </li>
                        </ul>
                    </li>
                    <li>
